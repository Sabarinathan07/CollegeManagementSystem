...
welcome_text = Label(frame2, text = "View/Edit Notice Board", font=("Minion Pro Regular", 16), bg="#89c4f4")
...
NameLabel=Label(leftbox,text="Company Name",font=("Helvetica",15),fg="#eae2b7",bg="#0C487F")
NameLabel.place(x=10, y =90)
NameEntry=Entry(leftbox,font=("Helvetica",15),bd=0)
NameEntry.place(x=160, y =90, width = 317)
YearLabel=Label(leftbox,text="Year",font=("Helvetica", 15),fg="#eae2b7",bg="#0C487F")
...
deletebt=Button(btnfrm,text="Delete",font=("Helvetica", 12),bg="indianred",fg="black",command=delete1, bd =0)
deletebt.configure(state = "disabled")
deletebt.place(x=250, y=0, width = 70)
clrbt=Button(btnfrm,text="Clear",font=("Helvetica", 12),bg="indianred",fg="black",command=clear, bd = 0)
