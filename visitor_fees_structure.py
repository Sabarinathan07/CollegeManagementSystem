...
welcome_text = Label(frame2, text = "Fees Structure", font=("Minion Pro Regular", 16), bg="#89c4f4")
...
result.place(x=200,y=130,width=585,height=327)
image1 = Image.open("media/fee.png")
