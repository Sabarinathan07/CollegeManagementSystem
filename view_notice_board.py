...
welcome_text = Label(frame2, text = "Search Notice Board", font=("Minion Pro Regular", 16), bg="#89c4f4")
...
# INSIDE LEFT BOX
leftbox_title=Label(leftbox,text="View Details",font=("Helvetica",20,"bold"),fg="#eae2b7",bg="#0C487F")
