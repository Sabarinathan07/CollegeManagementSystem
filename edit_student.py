...
#heading label
nsec=Label(header, text="SRM Institute of Science and Technology",font=("Helvetica", 28,"bold"), bg = "#0C487F",fg="#eae2b7")
nsec.place(x=0, y=10, width=900)
#Profile frame
frame2=Frame(root, bg="#89c4f4")
frame2.place(x=0,y=75,width=900,height=50)
welcome_text = Label(frame2, text = "View/Edit Student (by Name OR UID)", font=("Minion Pro Regular", 16), bg="#89c4f4")
...
# LEFT BOX
leftbox=Frame(root,bd=0,bg="#0C487F")
leftbox.place(x=10,y=140,width=300,height=350)

# INSIDE LEFT BOX
leftbox_title=Label(leftbox,text="Manage Database",font=("Helvetica",20,"bold"),fg="#eae2b7",bg="#0C487F")
leftbox_title.place(x=30, y=10)
IdLable=Label(leftbox,text="ID",font=("Helvetica",15),fg="#eae2b7",bg="#0C487F")
IdLable.place(x=10, y =50)
IdEntry=Entry(leftbox,font=("Helvetica",15),bd=0)
IdEntry.insert(0,random_string())
IdEntry.place(x=200, y =50, width = 80)
NameLable=Label(leftbox,text="Name",font=("Helvetica", 15),fg="#eae2b7",bg="#0C487F")
NameLable.place(x=10, y=100)
NameEntry=Entry(leftbox,font=("Helvetica", 15),bd=0)
NameEntry.place(x=80, y=100, width = 200)
SemesterLable=Label(leftbox,text="Semester",font=("Helvetica", 15),fg="#eae2b7",bg="#0C487F")
SemesterLable.place(x=10, y=150)
SemesterEntry=Entry(leftbox,font=("Helvetica", 15),bd=0)
SemesterEntry.place(x=130, y=150, width = 150)
DepartmentLable=Label(leftbox,text="Department",font=("Helvetica", 15),fg="#eae2b7",bg="#0C487F")
...
# LEFT BOX BUTTONS
btnfrm=Frame(leftbox, bd=0, bg="#0C487F")
btnfrm.place(x=10,y=250,width=290,height=50)

addbt=Button(btnfrm,text="Add",font=("Helvetica", 12),bg="indianred",fg="black",bd=0,command=add)
addbt.place(x=50, y=0, width = 70)
updatebt=Button(btnfrm,text="Edit",font=("Helvetica", 12),bg="indianred",fg="black",bd=0,command=update)
updatebt.configure(state = "disabled")
updatebt.place(x=140, y=0, width = 70)

btnfrm2=Frame(leftbox,relief=RIDGE,bg="#0C487F")
btnfrm2.place(x=10,y=300,width=290,height=50)

deletebt=Button(btnfrm2,text="Delete",font=("Helvetica", 12),bg="indianred",fg="black",command=delete1, bd =0)
deletebt.configure(state = "disabled")
deletebt.place(x=50, y=0, width = 70)
clrbt=Button(btnfrm2,text="Clear",font=("Helvetica", 12),bg="indianred",fg="black",command=clear, bd = 0)
...
# RIGHT BOX HEADING
searchBy=Label(rightbox,text="Enter Value",font=("Helvetica", 14),bg="indianred",fg="black")
...
dropdown['values']=("--Search By--", "Name", "UID", "Semester", "Department")
dropdown.current(0)
...
note_text=Label(rightbox,font=("Helvetica", 10),bg="indianred",fg="black")
