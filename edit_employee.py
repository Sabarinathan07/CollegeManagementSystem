...
welcome_text = Label(frame2, text = "View/Edit Employee (by Name OR UID)", font=("Minion Pro Regular", 16), bg="#89c4f4")
...
IdLabel=Label(leftbox,text="ID",font=("Helvetica",15),fg="#eae2b7",bg="#0C487F")
IdLabel.place(x=10, y =50)
IdEntry=Entry(leftbox,font=("Helvetica",15),bd=0)
IdEntry.insert(0,random_string())
IdEntry.place(x=200, y =50, width = 80)
NameLabel=Label(leftbox,text="Name",font=("Helvetica", 15),fg="#eae2b7",bg="#0C487F")
NameLabel.place(x=10, y=100)
NameEntry=Entry(leftbox,font=("Helvetica", 15),bd=0)
NameEntry.place(x=80, y=100, width = 200)
DesignationLabel=Label(leftbox,text="Designation",font=("Helvetica", 15),fg="#eae2b7",bg="#0C487F")
...
DepartmentLabel=Label(leftbox,text="Department",font=("Helvetica", 15),fg="#eae2b7",bg="#0C487F")
